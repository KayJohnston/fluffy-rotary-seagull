...
# Kay Johnston
# Ready?  Aye ready!
# Self-setting version, for current user only.  Will need to authenticate with current password to prevent abuse!
...
class App():
    ...
    def __init__(self,master):
        ...
        # Create a label to show the currently logged-in user.
        self.current_user = os.getlogin()
        self.current_username = StringVar()
        self.current_username.set(self.current_user)
        self.current_username_label = Label(self.status_frame, textvariable = self.current_username)
